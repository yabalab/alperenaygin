    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          className="fixed bottom-[18px] right-[18px] z-[48] inline-flex items-center gap-[9px] rounded-full border border-[rgba(184,149,106,0.45)] bg-[rgba(14,14,12,0.9)] px-[22px] pb-[14px] pt-[15px] font-body text-[10px] font-light uppercase tracking-label text-paper backdrop-blur-[10px] transition-colors duration-500 ease-smooth hover:bg-[rgba(138,111,79,0.95)]"
